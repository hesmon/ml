...
W2 | (7,9/7/1398) Lecture 3-4: Linear regression in matrix form; polynomial regression; basis function; Ridge regression; The LASSO; generalization error; cross validation (whiteboard notes) | **Required:** FCML, Sec. 1.4-6; ESL, P. 43-46 <br> <br>  | [HW2](homeworks/HW2.pdf)  | HM |
